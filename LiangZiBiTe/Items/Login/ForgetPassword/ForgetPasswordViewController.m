...
//  LiangZiBiTe
//
//  Created by zhandb on 2018/9/23.
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self setNavgiationBarTitle:@"修改密码"];
...
- (IBAction)registerButtonClicked:(id)sender {
    ...
    [App_HttpsRequestTool forgetPasswordWithphone:self.mobileTextField.text code:self.codeTextField.text pwd:self.passwordTextfield.text repwd:self.passwordAgainTextField.text withSuccess:^(id responseObject) {
        ...
        if ([response isSuccess]) {
            ...
            [SVProgressHUDManager popTostSuccessWithString:@"修改密码成功"];
        }else{
            PopInfo(failMsg);
        }
